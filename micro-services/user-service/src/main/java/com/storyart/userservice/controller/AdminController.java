...
public class AdminController {
    ...
    public ResponseEntity<?> activateUserAccount(@PathVariable Integer uid, @RequestParam(value = "setActive") boolean setActive) {
        userService.findById(uid).setActive(true);
        if (setActive) {
...
//    }
    ...
    @GetMapping
    public PagedResponse<User> findByUsernameLike(@RequestParam(value = "page", defaultValue = AppContants.DEFAULT_PAGE_NUMBER) int page,
                                                  @RequestParam(value = "size", defaultValue = AppContants.DEFAULT_PAGE_SIZE) int size, @RequestParam(value = "s") String searchtxt) {
